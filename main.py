...
pygments_colors = {
    ...
    Token.Name: (212, 212, 212),
    Token.Name.Attribute: (220, 220, 170),
    Token.Name.Builtin: (78, 201, 176),
    Token.Name.Builtin.Pseudo: (78, 201, 176),
    Token.Name.Class: (220, 220, 170),
    Token.Name.Constant: (78, 201, 176),
    Token.Name.Decorator: (201, 162, 253),
    Token.Name.Entity: (220, 220, 170),
    Token.Name.Exception: (220, 220, 170),
    Token.Name.Function: (220, 220, 170),
    Token.Name.Label: (220, 220, 170),
    Token.Name.Namespace: (220, 220, 170),
    Token.Name.Other: (212, 212, 212),
    Token.Name.Tag: (86, 156, 214),
    Token.Name.Variable: (212, 212, 212),
    Token.Name.Variable.Class: (212, 212, 212),
    Token.Name.Variable.Global: (212, 212, 212),
    Token.Name.Variable.Instance: (212, 212, 212),

    Token.Literal: (214, 157, 133),
    Token.Literal.Date: (214, 157, 133),
    Token.Literal.String: (214, 157, 133),
    Token.Literal.String.Backtick: (214, 157, 133),
    Token.Literal.String.Char: (214, 157, 133),
    Token.Literal.String.Doc: (214, 157, 133),
    Token.Literal.String.Double: (214, 157, 133),
    Token.Literal.String.Escape: (214, 157, 133),
    Token.Literal.String.Heredoc: (214, 157, 133),
    Token.Literal.String.Interpol: (214, 157, 133),
    Token.Literal.String.Other: (214, 157, 133),
    Token.Literal.String.Regex: (214, 157, 133),
    Token.Literal.String.Single: (214, 157, 133),
    Token.Literal.String.Symbol: (214, 157, 133),

    Token.Literal.Number: (181, 206, 168),
    Token.Literal.Number.Bin: (181, 206, 168),
    Token.Literal.Number.Float: (181, 206, 168),
    Token.Literal.Number.Hex: (181, 206, 168),
    Token.Literal.Number.Integer: (181, 206, 168),
    Token.Literal.Number.Integer.Long: (181, 206, 168),
    Token.Literal.Number.Oct: (181, 206, 168),
    ...
    Token.Comment.Preproc: (106, 153, 85),
    Token.Comment.Single: (106, 153, 85),
    Token.Comment.Special: (106, 153, 85),

    Token.Generic: (212, 212, 212),
    Token.Generic.Deleted: (212, 0, 0),
    Token.Generic.Emph: (212, 212, 212),
    Token.Generic.Error: (212, 0, 0),
    Token.Generic.Heading: (78, 201, 176),
    Token.Generic.Inserted: (78, 201, 176),
    Token.Generic.Output: (128, 128, 128),
    Token.Generic.Prompt: (212, 212, 212),
    Token.Generic.Strong: (212, 212, 212),
    Token.Generic.Subheading: (78, 201, 176),
    Token.Generic.Traceback: (212, 0, 0),

    Token.Text: (212, 212, 212),
    Token.Text.Whitespace: (212, 212, 212),
}
